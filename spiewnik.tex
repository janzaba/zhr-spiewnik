...
\newindex{wejscieidx}{wejscieidx}
\newindex{wystawienieidx}{wystawienieidx}
...
\begin{document}
	...
	\ifchorded
		% to regenerate indexes run sh ./reindex.sh
		% then compile this file again
		\showindex[2]{Spis treści}{titleidx}
		\showindex[2]{Pieśni na wejście}{wejscieidx}
		\showindex[2]{Pieśni na wystawienie}{wystawienieidx}
