...
\beginsong{Nie chcę w innym miejscu być}
\beginverse*
	\[D / G / h]Nie chcę w innym miejscu być \rep{3}
	Lecz w \[G]miłości Twej, w miłości Twej.
\endverse
\chordsoff
\beginchorus
	Więc rozpal ogień w duszy mej, niech płonie, niech pochłonie mnie.
	Boże, więcej Ciebie chcę! \rep{2}
\endchorus
\endsong


\beginsong{Chwalcie Pana Niebios}
\beginchorus
	\[e]Chwalcie Pana Niebios
	Chwalcie Go na cytrze
	\[D]Chwalcie Króla świata
	\[h]Bo On Bogiem \[e]jest
\endchorus
\chordsoff
\beginverse
...
\beginsong{Zmartwychwstał Pan i żyje dziś}
\beginchorus
	\[e]Zmartwychwstał Pan \[C]i żyje dziś,
	\[G]blaskiem jaśnieje \[D]noc
	\[e]Nie umrę, nie \[C]lecz będę żył,
	\[G]Pan okazał swą \[D]moc
	\[a]Krzyż to jest brama \[e]Pana,
	\[G]jeśli chcesz przez nią \[D]wejdź
	\[a]Zbliżmy się do oł\[e]tarza,
	\[G]Bogu oddajmy \[D]cześć.
\endchorus
\beginverse
	\[e]Dzięki \[D]składajmy \[G]Mu, bo \[a]wielka jest jego \[H7]łaska
	\chordsoff
...
\beginsong{Pan jest Pasterzem moim (choćbym nawet szedł)}
\beginverse*
	\[a]Pan \[d]jest \[G]Pasterzem \[a]moim,
	\[a]Niczego mi nie \[d]braknie, na zie\[G]lonych niwach \[a]pasie mnie.
	\[a]Nad spokojne \[d]wody \[G]mnie \[a]prowadzi
	I \[a]duszę mą po\[d]krzepia i \[F]wiedize mnie ścież\[G]kami, spra\[F]wiedli\[G]wości \[a]swojej.
\endverse
\beginchorus
	\[C]Choćbym nawet \[G]szedł \[d]ciemną \[a]doliną,
	\[C]Zła się nie u\[G]lęknę, \[d]boś Ty \[a]ze mną.
	\[C]Las\[G]ka \[D]Two\[a]ja i \[C]kij \[G]Twój \[D]mnie pocie\[a]szają.
	\[a]Na, na \[d]naj. \[G a]
\endchorus
\endsong